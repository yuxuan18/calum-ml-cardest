...
def load_and_encode_train_data(num_queries, num_materialized_samples, enable_stats=True, dataset="tpcds"):
    if dataset == "tpcds":
        file_name_queries = "data/tpcds"
        file_name_column_min_max_vals = "data/column_min_max_vals_tpcds.csv"
    elif dataset == "tpch":
        file_name_queries = "data/tpch"
        file_name_column_min_max_vals = "data/column_min_max_vals_tpch.csv"
...
def get_train_datasets(num_queries, num_materialized_samples, dataset="tpcds"):
